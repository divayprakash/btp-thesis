...
\begin{itemize}
    ...
    \item Remote debugging - The Raspberry Pi devices can be accessed by an administrator using \ac{ssh} for the purpose of code updation/ remote debugging etc. There is no need to obtain physical access to the device which would be difficult in most cases.
\end{itemize}
